"""Rookie draft big board for a Sleeper dynasty league.

Ranks this season's available rookies (dynasty value via FantasyCalc,
cross-referenced against roster needs), shows which picks you own in this
draft (including ones acquired by trade), and tracks who's on the clock.
...
def main() -> None:
    ...
    while True:
        state = gather_state(args.league_id, args.username, force_refresh_players)
        force_refresh_players = False
        print_report(state)
